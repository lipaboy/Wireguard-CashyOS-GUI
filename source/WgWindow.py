...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self._worker = None
        self._active_iface: str | None = None  # имя активного интерфейса
    ...
    def _detect_active(self):
        ...
        try:
            ...
            active: list[str] = r.stdout.strip().split()
    ...
    def _on_select(self, current, _prev):  # second var: _prev
        if current is None:
            return
    ...
    def _on_up(self):
        ...
        if self._active_iface:
            self._run_wg("down", self._active_iface)
